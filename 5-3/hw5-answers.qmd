...
\newpage
\noindent 4. Repeat the analysis in question 7 but include all states. Are your results different? If so, why?
```{r}
#| echo: false
#| label: tbl-ddregs3
...
\newpage
\noindent 6. Repeat part 9 but again include states that expanded after 2014.
```{r}
#| echo: false
